    ...
    <div className='custom'>
      ...
      <div className="screen_3 flex justify-center">
        <div className='w-screen'>
          <div className="box text-white bg-[#25b7aa] flex flex-col md:flex-row  p-4 mt-10 md:w-[60%] w-[90%] mx-auto cstm:w-[51%] max-w-6xl">
            ...
            <div className='md:w-[60%] cstm:flex cstm:flex-col cstm:justify-center cstm:leading-6  xcstm:text-[8px] border-t-2 md:border-t-0 border-white md:border-l-2 md:border-white md:pl-5 pl-0 font-bold text-[0.60rem] md:text-[16px]'>
          ...
          <div className="box flex flex-col md:flex-row mt-10 md:w-[60%] w-[90%]  mx-auto cstm:w-[51%] lg:w-[40%] max-w-6xl">
            <div className='flex flex-col  md:w-[60%]'>
              ...
              <div className="part2 text-black font-bold  mt-4 cstm:text-[12px] text-[0.60rem] md:text-lg">
                夜はスカイツリーのライティングを眺めることができる。<br />
                ライティングスケジュールはスカイツリー公式HPをチェック。
              </div>
              <div className="part3 flex p-2 justify-between mt-5 cstm:text-[12px]" style={{lineHeight:'24px'}}>
                <div>
          ...
          <div className="box flex flex-col md:flex-row  lg:mt-0 md:w-[60%] w-[120%] mx-auto cstm:w-[58%] max-w-6xl">
            <div className='flex flex-col md:w-[65%]'>
              <div className='relative border-l-2 border-white pl-5 font-bold text-lg'>
                <img src={s4new02} alt="building" className='pr-4 p-y-4 w-[100%]' />
            ...
            <div className='flex flex-col relative  md:w-[70%]'>
              <div className="part1 p-1 md:text-3xl cstm:text-[1.5rem] text-[#25b7aa] xcstm:text-sm font-bold border-b-4 border-[#25b7aa]">
                下町と新しい文化を融合した<br />
                カジュアルダイニング
              </div>
              <div className="part2 text-black cstm:text-[12px] md:text-[0.7rem] font-bold p-1 mt-4 xcstm:text-[0.4rem]" style={{lineHeight:'24px'}}>
              ...
              <div className="part3 flex p-1 justify-between mt-5 text-[0.8rem] cstm:text-[12px]" style={{lineHeight:'24px'}}>
                ...
                <div className='relative'>
                  <img src={s4lunch} alt="tower" className='cstm:w-[230px] cstm:translate-y-6' style={{marginRight:'70px'}} />
                  <div className='w-[80px] opacity-80 h-[25px] bg-[#fee33d] absolute cstm:translate-y-6 -top-0.5 rotate-[20deg] left-[35%] z-10'> </div>
                </div>

                <div className="absolute cstm:text-[0.6rem] bg-[#25b7aa] cstm:bottom-4  cstm:left-4 bottom-12 text-sm font-bold text-white p-3 lg:bottom-40 lg:left-28 xcstm:text-xs xcstm:-bottom-24">
      ...
      <div className="screen_5   flex justify-center mt-[20px]">
        <div className='w-screen'>
          ...
          <div className="box flex  md:flex-row flex-col-reverse p-4 mt-10 w-[90%] md:w-[60%] mx-auto cstm:w-[51%] max-w-6xl">
            <div className='flex flex-col  md:w-[60%]  relative'>
              <div className="part1 p-2 md:text-3xl cstm:text-[1.4rem] text-[#25b7aa] font-bold border-b-4 border-[#25b7aa] xcstm:text-sm">
                墨田区の魅力を発見できる<br />
                ショップ&ワークショップの店
              </div>
              <div className="part2  text-black font-semibold cstm:text-[9px] cstm:scale-125  cstm:translate-x-10  p-2 mt-4 md:text-[15px] xcstm:text-[0.45rem]"style={{lineHeight:'18px'}}>
              ...
              <div className="part3 flex flex-col md:flex-row p-2 justify-between mt-5 xcstm:text-xs" style={{lineHeight:'18px'}}>
                ...
                <div className='absolute md:translate-x-16 z-20 mt-5 md:mt-0  -right-48 cstm:translate-x-52 top-[11rem]'>
            ...
            <div className='md:w-[40%] cstm:w-[70%] cstm:translate-x-10 relative  pl-5 font-bold text-lg md:mt-0 mt-10 max-w-6xl'>
        ...
        <div className='w-screen'>
          <div className="box text-white bg-[#f5ac1a] flex flex-col md:flex-row p-4 w-[60%] mx-auto cstm:w-[51%] xcstm:w-[90%] max-w-6xl">
            <div className='flex flex-col justify-center items-center md:w-[40%] pb-5 md:pb-0'>
              <div className='text-bold md:text-3xl cstm:text-xl'>Shibuya</div>
              <div className='font-bold md:text-5xl cstm:text-3xl'>渋谷</div>
            </div>
            <div className='md:w-[60%] cstm:flex cstm:flex-col cstm:justify-center border-t-2 md:border-t-0 border-white md:border-l-2 md:border-white md:pl-5 pl-0 font-bold md:text-sm xcstm:text-[0.53rem] nokn:text-xs'>
              <div>若者や外国人観光客が集まる流行の発信地・渋谷で、東京の“いま”</div>
              <div>を体感!</div>
            </div>
          </div>

          <div className="box flex flex-col md:flex-row  mt-10 md:w-[60%] mx-auto cstm:w-[51%] max-w-6xl">
            <div className='flex flex-col md:w-[60%] cstm:w-[80%]'>
              <div className='relative  font-bold text-lg cstm:-translate-x-12'>
                <img src={s6shibuya_sky_new} alt="" className='' />
              </div>
            ...
            <div className='flex flex-col relative  md:w-[60%] cstm:w-[80%]'>
              ...
              <div className="part2 text-black md:text-[0.8rem]  font-bold p-1 mt-4 xcstm:text-[0.54rem] cstm:text-[11.5px]" style={{lineHeight:'20px'}}>
                <div>2019年に開業した「渋谷スクランブルスクエア」にある展望施設「</div>
                <div>SHIBUYASKY」は、街を一望できる絶景スポット。 屋内展望回廊 「SKY-</div>
                GALLERY」では映像による空間演出や期間限定の展示が楽しめる。
              </div>
              <div className="part3 flex flex-col md:flex-row p-1 justify-between mt-5 xcstm:text-[0.8rem] md:text-[1.1rem] cstm:text-[0.8rem]" style={{lineHeight:'20px'}}>
                <div>
                ...
                <div className='absolute z-20 md:-bottom-12 md:right-0 -bottom-52 cstm:-right-12 right-0 text-sm font-bold text-white p-3'>
                  <img src={s6cupimg} alt="tower" />
                </div>

                <div className="absolute bg-[#f5ac1a] md:-bottom-12 md:right-56 -bottom-[240px] cstm:-bottom-6 cstm:right-48 right-48 md:text-sm xcstm:text-[0.6rem] font-bold text-white p-3">
      ...
      {/* Screen 7 */}
      <div className="screen_7 flex justify-center mt-[-40px]">
        <div className='w-screen'>
          <div className="box flex flex-col md:flex-row mt-36 md:w-[60%] mx-auto pt-4 cstm:w-[51%] max-w-6xl">
            <div className='flex flex-col  md:w-[60%] cstm:w-[145%]'>
              ...
              <div className="part2 text-black cstm:text-[12px] cstm:-translate-x-6 font-bold mt-4 md:text-[0.7rem] xcstm:text-[0.5rem] nokn:text-[0.6rem]"style={{lineHeight:'20px'}}>
            ...
            <div className='md:w-[40%]  cstm:w-[95%] cstm:translate-x-[30px] relative font-bold text-lg'>
      ...
      {/* Screen 8 */}
      <div className="screen_8 flex justify-center mt-[40px] ">
          ...
          <div className="relative box flex flex-col md:flex-row mt-10 md:w-[60%] mx-auto cstm:w-[65%] max-w-6xl">
            <div className=' flex flex-col md:w-[60%] cstm:w-[120%]  '>
              <div className='relative  font-bold text-lg'>
                <img src={s8main_image} alt="" className='p-4' />
              </div>
            ...
            <div className=' flex flex-col relative  md:w-[60%]  cstm:w-[100%] '>
              <div className="part1 p-1 text-3xl text-[#f7aa17] font-bold border-b-4 border-[#f7aa17]">
                パンとコーヒーで <br />
                素敵なカフェタイムを
              </div>
              <div className="part2 text-black md:text-[0.7rem] font-bold p-1 mt-4 xcstm:text-[0.5rem]"style={{lineHeight:'20px'}}>
        ...
        <div className='w-screen'>
          <div className="box flex flex-col md:flex-row p-4 mt-32 md:w-[60%] mx-auto cstm:w-[65%] max-w-6xl">
            <div className='flex flex-col  md:w-[60%] cstm:translate-x-8'>
              ...
              <div className="part2 text-black cstm:text-[12px] font-bold p-2 mt-4 xcstm:text-[0.5rem] md:text-[0.9rem]"style={{lineHeight:'20px'}}>
                芝生ひろばをはじめ、ボルダリングウォール・スケート場・多目的運動施設 <br />
                (サンドコート)を併設。
              </div>
              <div className="part3 flex flex-col md:flex-row p-2 justify-between mt-5 cstm:text-[12px]" style={{lineHeight:'20px'}}>
                <div>
                  <div className='text-[#f3bc3c] font-semibold'>●渋谷区立宮下公園</div>
                  <div className='text-black font-semibold'>東京都渋谷区神宮前1-26-5</div>
                  <div className='text-black font-semibold'> <span><img src={phone_image} alt="phone" className='inline w-[15px]' /></span> 03-6712-5291</div>
                  ...
                  <div className='text-black font-semibold'>休/年末年始</div>
                </div>
              </div>
            </div>
      ...
      {/* Screen 10 */}
      <div className="screen_10  flex justify-center mt-[100px]">
        ...
        <div className='w-screen'>
          ...
          <div className="box flex flex-col md:flex-row p-4 mt-10 md:w-[60%] mx-auto cstm:w-[65%] max-w-6xl">
            <div className='flex flex-col md:w-[60%] xcstm:w-[90%]'>
              <div className='relative  font-bold text-lg'>
                <img src={s10newImage} alt="storefront_image" className='p-4' />
              </div>
            </div>
            ...
            <div className='flex flex-col relative  md:w-[60%]'>
              ...
              <div className="part2 text-black md:text-[0.7rem] cstm:text-[12px] xcstm:text-[0.45rem] font-bold p-1 mt-4" style={{lineHeight:'20px'}}>
                世界ピンチョス・タパスコンクールでチャンピオンに輝いた名店「GRAN- SOL」<br />
                の日本1号店 3周年を記念し、東京オリジナルピンチョスが登場予
                <br /> 定!
              </div>
              <div className="part3 flex p-1 justify-between mt-5 xcstm:text-[0.6rem] cstm:text-[12px] md:text-[0.8rem]" style={{lineHeight:'20px'}}>
                <div>
                  <div className='text-[#f5ac1a] font-bold'>●GRAN SOL TOKYO</div>
                  <div className='text-black font-bold'>東京都渋谷区神宮前6-20-10</div>
                  <div className='text-black font-bold'>MIYASHITA PARK North3F</div>
                  <div className='text-black font-bold'> <span><img src={phone_image} alt="phone" className='inline w-[15px]' /></span> 03-5468-3378</div>
                  ...
                  <div className='text-black font-bold'> <span><img src={instagram_icon} alt="insta" className='inline' /></span> {"@gransol shibuya"}</div>
                </div>
          ...
          <div className="flex flex-col md:flex-row md:mt-5 cstm:w-[65%] md:w-[60%] xcstm:w-[90%] mx-auto cstm:items-center justify-center md:translate-x-20 xcstm:mt-10">
            ...
            <img src={s10combined} alt="combined" className='w-[80%]' />
      ...
      <div className="screen_11  flex justify-center mt-[20px]">
        <div className='w-screen'>
          ...
          <div className="box flex flex-col md:flex-row p-4 mt-5 md:w-[60%] mx-auto cstm:w-[60%] max-w-6xl cstm:translate-x-12">
            <div className='flex flex-col  md:w-[60%] cstm:w-[50%]'>
              ...
              <div className="part2 text-black cstm:-translate-x-2 cstm:text-[11.5px] font-bold p-2 mt-4 md:text-[15px] xcstm:text-[8px] flex flex-col items-center " style={{lineHeight:'20px'}}>
                <div>世界各国から厳選したロースターの豆を扱うコーヒー専門店。豆の産地 <br />
            ...
            <div className='md:w-[40%] cstm:w-[60%]  relative pl-5 xcstm:mt-28 md:mt-0 font-bold text-lg'>
              <img src={s11Koffee} alt="couple_date" />
            </div>
          </div>

          <div className="box2 flex flex-col md:flex-row justify-between p-4 mx-auto md:w-[60%] cstm:[60%] max-w-6xl">
            <div className='cstm:translate-x-10 cstm:text-[12px]' style={{lineHeight:'20px'}}>
              <div className="part2 text-black text-[12px] font-bold p-1 mb-4" style={{lineHeight:'20px'}}>
              ...
              <div className='text-black font-bold'><span><img src={phone_image} alt="phone" className='inline w-[15px]' /></span> 03-6240-3072 (予約優先)</div>
              <div className='text-black font-bold'>営/11:00-19:00</div>
              <div className='text-black font-bold'>休/無休</div>
              <div className='text-black font-bold'><span><img src={instagram_icon} alt="insta" className='inline' /></span> @koffee_mameya_kakeru</div>
            </div>
            ...
            <div className="image_part flex justify-center items-center xcstm:translate-y-20 md:translate-y-0 cstm:-translate-x-5">
              ...
              <div className='relative -translate-y-14'>
                <img src={s11downright} alt="rightimage" className='w-[240px]' />
      ...
      <div className="screen_12  justify-center mt-[20px]">
        ...
        <div className='w-screen'>
          ...
          <div className="box flex flex-col md:flex-row p-4 xcstm:mt-20 md:mt-10 md:w-[60%] mx-auto xcstm:w-[90%] cstm:w-[60%] max-w-6xl">
            <div className='flex flex-col md:w-[60%]'>
              <div className='relative  font-bold xcstm:text-sm md:text-lg cstm:w-[110%] cstm:-translate-x-10'>
                <img src={s12allpress} alt="storefront_image" className='p-4 ' />
            ...
            <div className='flex flex-col relative  md:w-[60%]'>
              ...
              <div className="part2 text-black xcstm:text-[0.45rem] cstm:text-[12px] md:text-[0.8rem] font-bold p-1 mt-4" style={{lineHeight:'20px'}}>
                ニュージーランド発のロースター&カフェ、2022年4月に、 店舗&メニュー <br />
                をリニューアル。 焙煎士との距離が近いので、好みの味を探したい方はぜ <br />
                ひ。
              </div>
              <div className="part3 flex p-1 justify-between mt-5 xcstm:text-sm md:text-[1rem] cstm:text-[12px]" style={{lineHeight:'20px'}}>
                <div>
                  <div className='text-[#00aee0] font-bold mb-[2px]'>●Allpress Espresso Tokyo Roastery&Cafe</div>
                  <div className='text-black font-bold mb-[2px]'>東京都江東区平野3-7-2</div>
                  <div className='text-black font-bold mb-[2px]'> <span><img src={phone_image} alt="phone" className='inline w-[15px]' /></span> 03-5875-9131</div>
                  <div className='text-black font-bold mb-[2px]'>営/9:00-17:00</div>
                  <div className='text-black font-bold mb-[2px]'>休/無休</div>
                  <div className='text-black font-bold mb-[2px]'><span><img src={instagram_icon} alt="insta" className='inline' /></span> {"@allpressespressojapan"}</div>
                </div>
          ...
          <div className="flex flex-col md:flex-row  mt-[-8px] md:w-[60%] mx-auto justify-center">
            ...
            <img src={s12allpress02} alt="all_press" />
          </div>
      ...
      <div className="screen_13 flex justify-center mt-[20px]">
        <div className='w-screen'>
          ...
          <div className="box flex flex-col md:flex-row  mt-4 md:w-[60%] xcstm:w-[90%] mx-auto cstm:w-[60%] max-w-6xl">
            <div className='flex flex-col  md:w-[60%] cstm:w-[50%] cstm:translate-x-10'>
              ...
              <div className="part2 text-black xcstm:text-[0.4rem] cstm:text-[11.5px] md:text-[0.8rem] font-bold  mt-4" style={{lineHeight:'20px'}}>
                豊かな木場公園内にある現代美術専門の美術館図書室には「こども <br />
                としょしつ」、エントランスや中庭にはベンチがあり、寛ぐことができる。ア <br />
                ートに触れて、心安らぐひと時を
              </div>
              <div className="part3 flex p-2 justify-between mt-5 xcstm:text-xs md:text-md font-bold" style={{lineHeight:'20px'}}>
                <div>
                  ...
                  <div className='text-black font-bold cstm:mb-[5px]'>料/入館のみは無料観覧料は展覧会により異なる</div>
                </div>
              </div>
            ...
            <div className='md:w-[40%] cstm:w-[60%] cstm:translate-x-10 relative xcstm:mt-20 md:mt-0  font-bold text-lg '>
      ...
      <div className="screen_14  flex justify-center md:mt-[20px] xcstm:mt-[60px]">
        ...
        <div className='w-screen'>
          <div className="box text-white bg-[#ee798c] flex flex-col md:flex-row p-4 mt-10 md:w-[60%] xcstm:w-[90%] mx-auto cstm:w-[55%] max-w-6xl">
            ...
            <div className='md:w-[60%] cstm:flex cstm:flex-col justify-center cstm:text-[14px]  md:border-l-2 xcstm:border-l-0 xcstm:border-t-2 md:border-t-0  border-white pl-5 font-bold xcstm:text-[0.45rem] md:text-[1rem]'>
              <div>小田急線線路跡の開発が進み、変化がめまぐるしい下北沢。新しい <br />
              発見がある“街ぶら”に最適なエリア。</div>
            </div>
          </div>

          <div className="box flex flex-col md:flex-row p-4 mt-5 md:w-[60%] xcstm:w-[90%] mx-auto cstm:w-[58%] max-w-6xl">
            <div className='flex flex-col md:w-[60%]'>
              ...
              <div className="part1 p-1 md:text-[1.4rem] cstm:text-[24px] xcstm:text-sm text-[#ee798c] font-bold border-b-4 border-[#ee798c]  sm:mt-10 md:mt-24" style={{lineHeight:'36px', marginTop:'115px'}}>
                新しい出会いや感性が刺激される<br />
                カルチャーの発信地!
              </div>
              <div className="part2 text-black cstm:text-[12px]  xcstm:text-[0.5rem] md:text-[0.7rem] font-bold p-1 mt-4" style={{lineHeight:'20px'}}>
                2020年春「下北線路街」 の一角にOPEN。 個性豊かな13のお店が軒を <br />
                重ね、小さな街を形成、不定期で開催されるイベントもCheck!
              </div>
              <div className="part3 flex flex-col cstm:text-[12px] md:flex-row p-1 justify-between mt-5 text-[0.7rem]" style={{lineHeight:'20px'}}>
                <div>
                  <div className='text-[#ee798c] font-bold'>●BONUS TRACK</div>
                  <div className='text-black font-bold'>東京都世田谷区代田2-36-12~15</div>
                  <div className='text-black font-bold'><span><img src={phone_image} alt="phone" className='inline w-[15px]'/></span><span>※各店舗へお問合せください</span></div>
                  <div className='text-black font-bold'><span><img src={instagram_icon} alt="insta" className='inline' /></span>{"@bonustrack_skz"}</div>
                </div>
              </div>
            </div>
